...
# class AppDelegate
#   attr_reader :navigation_controller, :window, :text_field, :screen_frame, :button, :root_view_controller
#
#   def application(application, didFinishLaunchingWithOptions:launchOptions)
...
#     @root_view_controller = UIViewController.alloc.init
#     root_view_controller.title = 'FirstApp'
#     root_view_controller.view.backgroundColor = UIColor.whiteColor
...
#     @text_field = UITextField.alloc.initWithFrame(text_field_frame)
#     style_text_field
#     root_view_controller.view.addSubview(text_field)
#   end
#
#   def create_button
#     @button = UIButton.buttonWithType(UIButtonTypeSystem)
#     style_button
#     root_view_controller.view.addSubview(button)
#   end
#
#   def send_message
#     view_controller = UIViewController.alloc.init
#     view_controller.title = 'Check Text'
...
#     text_view.font = UIFont.systemFontOfSize(25)
#     text_view.editable = false
#     view_controller.view = text_view
